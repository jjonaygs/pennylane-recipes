...
RSpec.describe Recipe, type: :model do
  describe 'associations' do
    ...
    let!(:recipe1) {
 Recipe.create!(title: "Vegetable Soup", category: "Soup", author: "John Doe", ratings: 5, image: "image_url",
cuisine: "Global") }
    let!(:recipe2) {
 Recipe.create!(title: "Carrot Salad", category: "Salad", author: "Jane Doe", ratings: 4, image: "image_url",
cuisine: "Global") }
    let!(:recipe3) {
 Recipe.create!(title: "Potato Mash", category: "Side", author: "Alex Doe", ratings: 5, image: "image_url",
cuisine: "Global") }
    let!(:recipe4) {
 Recipe.create!(title: "Onion Rings", category: "Appetizer", author: "Chris Doe", ratings: 4, image: "image_url",
cuisine: "Global") }
  ...
  describe 'scopes' do
    ...
    let!(:recipe1) {
 Recipe.create!(
  title: "Vegetable Soup", category: "Soup", author: "John Doe", ratings: 5, image: "image_url",
  cuisine: "Global") }
    let!(:recipe2) {
      Recipe.create!(title: "Carrot Salad", category: "Salad", author: "Jane Doe", ratings: 4, image: "image_url",
      cuisine: "Global") }
