...
RSpec.describe RecipesController, type: :controller do
  ...
  let!(:recipe1) { double("Recipe", id: 1, title: "Vegetable Soup", category: "Soup", author: "John Doe", ratings: 5, image: "image_url", cuisine: "Global") }
  let!(:recipe2) { double("Recipe", id: 2, title: "Carrot Salad", category: "Salad", author: "Jane Doe", ratings: 4, image: "image_url", cuisine: "Global") }
  let!(:recipe3) { double("Recipe", id: 3, title: "Potato Mash", category: "Side", author: "Alex Doe", ratings: 5, image: "image_url", cuisine: "Global") }
